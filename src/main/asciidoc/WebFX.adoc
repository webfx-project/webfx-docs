...
The init command just creates 2 files (webfx.xml and pom.xml) at the root level of your repository. If this is the first time you use it, it will also download some webfx.xml files from the Maven repository to get the meta info about the essential WebFX modules, before completing the job.
...
You can simply open the webfx-example directory from your Java IDE. It will recognize it as a Maven project, and import it.

==== Configuring the OpenJFX application

Here is how to create the configuration:
