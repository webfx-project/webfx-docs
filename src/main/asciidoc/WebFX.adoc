...
To develop WebFX apps, you will need the following software installed on your development machine:
...
NOTE: The WebFX CLI is required only on your local development machine (not on your CI/CD pipeline). And it is not required for the build, or the execution of WebFX apps.
