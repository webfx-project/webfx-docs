...
Some alternative technologies or JVM languages also support cross-platform development, but rely on platform-specific UI implementations rather than compiling from a single UI API.
