...
Despite the large size of OpenJFX, WebFX can produce lightweight web apps, as demonstrated by the demos and the website:
...
[small]#* compressed JS size transferred over the network, excluding images and other resources#
...
* GWT produces compact and optimized JS code, leading to highly performant web apps.
