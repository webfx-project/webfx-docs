...
In addition to the web platform, WebFX will help you to build your application for the desktop & mobiles thanks to the Java & Gluon toolchains.

Some other JVM technologies allows you to do the same but only for the application logic, they don't offer a cross-platform UI toolkit. With WebFX, you can do a full cross-platform development of your entire application from a single source code base.
...
[small]#* these tools are optional, allowing you to create a Windows installer#
