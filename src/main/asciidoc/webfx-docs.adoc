...
Then you can check the Web version by running a GWT build, and then open the html file in the browser, using one of the different methods already explained.
